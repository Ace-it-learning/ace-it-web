/**
 * Seed Batch 2 CUHK programme details (PREMIUM version with 8 sections) into Cosmos DB
 * Also seeds base programme metadata so API routes work correctly.
 * Run: node backend/scripts/cuhk/seed-cuhk-batch2.js
 */

require("dotenv").config({ path: require("path").join(__dirname, "../../.env") });
const JupasProgrammeService = require("../../services/JupasProgrammeService");
const batchData = require("./cuhk-batch2-details.json");
const programmesMeta = require("./cuhk-batch2-programmes.json");
...
async function seed() {
    ...
    console.log(`[Seed] ========================================`);
    console.log(`[Seed] CUHK Batch 2 Seeding`);
